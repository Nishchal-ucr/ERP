...
export function AddShedDataEntryClient({
  ...
  const computedClosingBirds =
    openingBirds !== undefined &&
    shedData != null &&
    shedData.birdsMortality != null
      ? openingBirds - shedData.birdsMortality
      : undefined;
  const computedTotalEggsClosing =
    shedData != null &&
    shedData.standardEggsClosing != null &&
    shedData.smallEggsClosing != null &&
    shedData.bigEggsClosing != null
  ...
  const computedFeedConsumed =
    ...
    shedData != null &&
    shedData.feedClosing != null &&
    shedData.feedIssued != null
